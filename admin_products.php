      ...
      <div class="flex">
         ...
         <select name="category" class="box">
            <option value="" selected disabled>Select Category</option>
               <option value="vegitables">wholesale</option>
               <option value="fruits">flavour cashew</option>
               <option value="meat">normal cashew</option>
            
         </select>
         </div>
         <div class="inputBox">
         <input type="text" min="0" name="price" class="box" required placeholder="Enter Product Price">
